  ...
  setup(__props) {
    ...
    const onOrderConfirm = (id) => {
      common_vendor.index.showModal({
        ...
        success: async (res) => {
          if (res.confirm) {
            await services_order.putMemberOrderReceiptByIdAPI(id);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/Temp/uniapp/rabbit-uniapp/src/pagesOrder/list/components/OrderList.vue"]]);
